...
import type { Submission, SubmissionData, SubmissionPatch, SubmissionQuery, SubmissionService } from './submissions.class';
export type { Submission, SubmissionData, SubmissionPatch, SubmissionQuery };
export type SubmissionClientService = Pick<SubmissionService<Params<SubmissionQuery>>, (typeof submissionMethods)[number]>;
