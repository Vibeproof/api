...
export declare class ApprovalService<ServiceParams extends Params = ApprovalParams> extends KnexService<Approval, ApprovalData, ApprovalParams, ApprovalPatch> {
}
