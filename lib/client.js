...
const approvals_shared_1 = require("./services/approvals/approvals.shared");
const submissions_shared_1 = require("./services/submissions/submissions.shared");
...
const createClient = (connection, authenticationOptions = {}) => {
    ...
    client.configure(submissions_shared_1.submissionClient);
    client.configure(approvals_shared_1.approvalClient);
    return client;
};
